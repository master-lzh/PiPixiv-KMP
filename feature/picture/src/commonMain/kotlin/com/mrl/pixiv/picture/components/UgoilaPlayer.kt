...
import com.mrl.pixiv.util.Bitmap
import com.mrl.pixiv.util.asComposeImage
...
fun UgoiraPlayer(
    ...
    if (images.isNotEmpty()) {
        ...
        if (playUgoira) {
            ...
            Image(
                bitmap = images[currentIndex].first.asComposeImage(),
            ...
            Box {
                Image(
                    bitmap = images[0].first.asComposeImage(),
                    contentDescription = null,
                    contentScale = ContentScale.FillWidth,
                    modifier = Modifier
                        .fillMaxWidth(),
